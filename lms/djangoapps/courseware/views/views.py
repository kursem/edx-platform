...
from lms.djangoapps.courseware.toggles import course_is_invitation_only, courseware_mfe_search_enabled
...
@api_view(['GET'])
def is_mfe_search_enabled(request, course_id=None):
    """
    Simple GET endpoint to expose whether the course may use Courseware Search.
    """
    payload = { "enabled": courseware_mfe_search_enabled() }
